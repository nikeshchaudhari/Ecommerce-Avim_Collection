...
const Checkout = () => {
  ...
  const order = {
    ...
    shippingAddress: user.address,
    status: "pending",
    items: JSON.stringify(cart), // IMPORTANT
    total: cart.reduce(
        ...
        {isOpen && (
          <div className="px-4 sm:px-6 lg:px-12 py-5">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="mb-5">
                <div className="font-serif text-[38px] dark:text-white text-[#1C1C1C] tracking-wide mb-1">
                  Checkout
                </div>
                <div className="text-[15px]  dark:text-white   text-gray-500 font-normal">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
                ...
                <div className="lg:col-span-7 space-y-6">
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="text-[14px] font-medium  dark:text-white  text-gray-800">
                    ...
                    <input
                      ...
                      className="w-full dark:text-white  dark:bg-black bg-[#FAF8F5] border border-gray-300 h-11 px-4 text-[14px] focus:outline-none focus:border-gray-500 transition-colors disabled:opacity-60"
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <textarea
                      ...
                      rows={4}
                      className="w-full  dark:text-white  dark:bg-black bg-[#FAF8F5] border border-gray-300 p-4 text-[14px] focus:outline-none focus:border-gray-500 transition-colors resize-none disabled:opacity-60"
                ...
                <div className="lg:col-span-4  dark:bg-black bg-white border border-gray-200/60 p-8 shadow-[0_4px_24px_rgba(0,0,0,0.01)]">
                  <div className="font-serif text-[22px] text-gray-900 tracking-wide mb-5">
                    Your Order
                  </div>

                  {/* ITEMS BRIEF SPECIFICATIONS LAYER */}
                  <div className="space-y-4 max-h-55 overflow-y-auto pr-1 mb-6">
                    {cartItems.length === 0 ? (
                  ...
                  <div className="space-y-5 pb-6 border-b border-gray-200 pt-4 border-t border-gray-100">
                    <div className="flex justify-between items-center text-[14px]">
                      ...
                      <div className="font-medium text-gray-900">NPR 500</div>
                    </div>

                    <div className="flex justify-between items-center text-[14px]">
                      <div className="text-gray-500">VAT (13%)</div>
                      <div className="font-medium text-gray-900">NPR 5000</div>
                    </div>
                  </div>
