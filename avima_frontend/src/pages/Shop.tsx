      ...
      <main className="bg-[#faf5ec] dark:bg-black min-h-screen pb-16">
        ...
        <div className="flex justify-center mt-10 px-4">
          <div className="w-full text-center">
            ...
            <h2 className="tracking-tight text-[35px] md:text-[50px] font-cormorant font-medium text-[#1c1c1c] mt-2 dark:text-white">
              Shop the Collection
            </h2>
            
            <div className="w-full flex justify-center mt-3">
              {/* Cleaned up width parameters for optimal text-wrapping layout bounds */}
              <p className="max-w-xl font-inter text-[14px] md:text-[16px] text-black/60 leading-relaxed  dark:text-white">
